"""
В самой первой проверке задачи ID = 87620839 тест 25 '-123'
Очевидно, что символ '-' не может в месте своего появления привести к выполнению действия
Поэтому взводится влаг minus_met а действие выполняется после литерала
то есть при достижении последующего пробела
Последний пробел к строке добавляется принудительно
"""
